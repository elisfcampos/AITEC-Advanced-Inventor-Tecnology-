...
### Entrega 2 - Projeto Executivo

| Tarefas | Colaborador | Início | Fim |
|---------|------------|--------|-----|
| ✅ Pesquisa de mesas dobráveis | Elisângela/Gabriel | 14/03/2025 | 17/03/2025 |
| ✅ Pesquisa de Materiais para a Arena estilo Mesa dobrável | Elisângela/Gabriel | 17/03/2025 | 20/03/2025 |
| ✅ Pesquisa de dobradiças | Elisângela/Gabriel | 20/03/2025 | 23/03/2025 |
| ✅ Pesquisa de Pés para a Arena tipo mesa | Elisângela/Gabriel | 20/03/2025 | 23/03/2025 |
| ✅ Estimativa de Preços para Materiais e Ferragens | Elisângela/Gabriel | 20/03/2025 | 23/03/2025 |
| ✅ Pesquisa de tipos de guarda corpo | Elisângela/Gabriel | 20/03/2025 | 22/03/2025 |
| ✅ Cálculo estimado de Peso da Arena Final | Elisângela/Gabriel | 22/03/2025 | 24/03/2025 |
| ✅ Cronograma | Elisângela/Gabriel | 22/03/2025 | 24/03/2025 |
| ✅ Documento Minuta | Elisângela | 24/03/2025 | 28/03/2025 |
| ✅ Revisão da Minuta no Git | Elisângela/Heloisa | 28/03/2025 | 31/03/2025 |
| ✅ Apresentação em PPT Arena | Elisângela/Gabriel | 28/03/2025 | 01/04/2025 |

### Entrega 3 - Projeto Executivo - Arena Montável
| Tarefas | Colaborador | Início | Fim |
|---------|------------|--------|-----|
| ✅ Pesq. tipos de encaixes em madeira	| Elisângela | 08/05/2025 | 10/05/2025 | 
| ✅ Modelo Encaixe em isopor		| Elisângela | 10/05/2025 | 10/05/2025 |
| ✅ Desenhos em 3D partes da Arena	| Elisângela | 10/05/2025 | 14/05/2025 |
| ✅ Desenho em Vista Explodida		| Elisângela | 12/05/2025 | 16/05/2025 |	
| ✅ Simulação Movimentação Da Arena	| Elisângela | 16/05/2025 | 25/05/2025 |
| ✅ Croqui das 4 partes da Arena	| Elisângela | 26/05/2025 | 28/05/2025 |
...
Cotado pelo site:\
Leo Madeiras -> https://www.leomadeiras.com.br/categoria/madeiras/madeiras-para-construcao/?produto=prancha&pagina=1&essencias=pinus&comprimento=3m 
...
Usaríamos 16 pedaços de 50 mm de altura x 1850 mm largura, sobrando 1950 mm de MDF, quase 2m de material.

Preço R$476,90 + Frete Grátis+ R$140,00 do tampo já com frete, perfazendo um total geral de R$616,90
...
# Projeto - Executivo - Arena Dobrável


## *Arena Dobrável - Gabriel* 

Após definido o formato da arena e suas dimensões determinei a movimentação e as características necessárias para o desenvolvimento da arena. 

Semana 2 (de 9 a 15 de maio) 

- Busca e pesquisa de base para escolha de materiais 
- Material escolhido para a base é o MDF, pois é rígido e barato 
- Para as barreiras superiores e os “pés” também foi escolhido um material de madeira, porém dessa vez de “pinho” pois possui uma densidade menor e também é rígido para impactos.

Semana 3 (de 16 a 24 de maio)
- Pesquisa de base para escolha da ferramenta de “abre fecha”
- Por recomendação de um marceneiro determinei a escolha de uma dobradiça chamada “dobradiça invisível” 
- Pedi auxilio da professora Fabiana para criar o movimento de “abre e fecha”
- Desenvolvimento de cad utilizando a dobradiça como meio de movimento

Semana 4 (de 23 a 29)
- Alterações pequenas no projeto que foram aparecendo durante o desenvolvimento
- Conversas com colegas apresentaram ideias para o acoplamento do placar na arena 
- Criação de vídeo para apresentação da movimentação

---


Orçamento para a Lona - Arena

**Lona + Impressão**  
- **Medida:** 2,10m x 1,60m  
- **Custo lona + impressão:** R\$ 270,00  
- **Custo da arte (lona):** R\$ 50,00  
- **Total:** R\$ 320,00  
...
**Adesivos (3 unidades)**  
1. **Fatec - SJC**  
   - Dimensões: 3,4cm x 23,6cm  

2. **Manufatura Avançada**  
   - Dimensões: 4,2cm x 47cm  

3. **QR Code + Logo Aitec**  
   - Dimensões: 7,2cm x 29,8cm  

- **Custo por unidade:** R\$ 60,00  
- **Custo da arte (adesivos):** R\$ 50,00  
- **Total:** R\$ 230,00  

---

**Arquivos de Arte**  
-  [**Fatec - AITEC (1).cdr**](https://github.com/elisfcampos/AITEC-Advanced-Inventor-Tecnology-/blob/566bdfa1528c95e46acd72ece472f975085dcec9/Arena/Fatec%20-%20AITEC%20(1).cdr)  
- [**Fatec - AITEC.pdf**](https://github.com/elisfcampos/AITEC-Advanced-Inventor-Tecnology-/blob/566bdfa1528c95e46acd72ece472f975085dcec9/Arena/Fatec%20-%20AITEC.pdf)  

- [PDF da arte em lona](media/image2.emf)  ->https://github.com/elisfcampos/AITEC-Advanced-Inventor-Tecnology-/blob/566bdfa1528c95e46acd72ece472f975085dcec9/Arena/Fatec%20-%20AITEC.pdf

---

**Imagens**  
<img src="https://github.com/elisfcampos/AITEC-Advanced-Inventor-Tecnology-/blob/cc0292f8b79ad934b5821cc0d7886d055a4fe127/Arena/Imagem01_Gabriel.jpg" alt="📸 Adesivos" width="600" />  
<br> **📸 Adesivos**

<img src="https://github.com/elisfcampos/AITEC-Advanced-Inventor-Tecnology-/blob/cc0292f8b79ad934b5821cc0d7886d055a4fe127/Arena/Imagem02_Gabriel.jpg" alt="📸 Impressão em Lona" width="800" />
<br> 📸 Impressão em Lona
...
Este trabalho de manufatura foi uma oportunidade valiosa para consolidar as competências desenvolvidas ao longo do semestre, especialmente aprofundarmos um pouco em **projetos CAD (Desenho Assistido por Computador)**. Através da criação da arena e dos componentes associados, enfrentamos desafios técnicos que exigiram criatividade e aplicação prática de conceitos teóricos.  

### **Principais Aprendizados:**  
**Modelagem CAD avançada** (uso de ferramentas como Catia, Sketchup, CorelDraw e Inventor para design e ajustes).  
**Cálculos de materiais** (peso, dimensões e custos de chapas, compensados e estruturas em PVC etc).  
**Integração multidisciplinar** (combinação de design, seleção de materiais para viabilizar o projeto).  
**Resolução de problemas** (adaptação a limitações de materiais, otimização de processos e custos).  

### **Desafios Enfrentados:**  
- **Complexidade do CAD:** A Simulação em Digital Mock-up exigida para movimentação feita no Catia e a necessidade de compatibilidade entre softwares reforçaram nosso conhecimento técnico.  
- **Otimização de recursos:** Seleção de materiais, Balancear custos, resistência de materiais (MDF, compensado, PSAI) e funcionalidade da arena.  
